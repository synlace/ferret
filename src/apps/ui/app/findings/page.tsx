      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <div className="flex items-center justify-between px-3 h-[48px] border-b border-neutral-800 bg-[#171717] flex-shrink-0">
          <div className="flex flex-col min-w-0">
            <span className="text-sm font-bold tracking-wider text-white">Findings</span>
            {activeProject ? (
              <span className="text-[10px] text-neutral-500 mt-0.5 leading-none whitespace-nowrap truncate">{activeProject.name}</span>
            ) : (
              <span className="text-[10px] text-neutral-500 mt-0.5 leading-none whitespace-nowrap truncate">Identified security issues</span>
            )}
          </div>
      ...
      {chatOpen && (
        <aside className="w-80 border-l border-neutral-800 flex flex-col bg-neutral-900 flex-shrink-0">
          <div className="flex items-center justify-between px-3 h-[48px] border-b border-neutral-800 bg-[#171717] flex-shrink-0 gap-3">
            <div className="flex flex-col min-w-0">
              <span className="text-sm font-bold tracking-wider text-white">AI Analyst</span>
              <span className="text-[10px] text-neutral-500 mt-0.5 leading-none">Security copilot</span>
            </div>
            <Button variant="ghost" size="icon" className="h-6 w-6 text-neutral-400 hover:text-white flex-shrink-0" onClick={() => setChatOpen(false)}>
